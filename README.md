...
| [FXMacroData](https://fxmacrodata.com) | Macroeconomic data from government sources, including announcement dates, covering currencies, interest rates, and economic indicators | `apiKey` | Yes | Yes | |
